...
data_folder <- "R:/Group Vermeulen/Lila/Mass_spec_results/V30_LK"

write.table(data_results, file = paste0(data_folder, "/data_results_v30_PD.tsv"), sep = "\t", row.names = FALSE)
...
# Plot a barplot for specific proteins -> change the protein name
